...
3. Add your players (real name → character name), or let the app detect them from your first transcript
4. Optionally add known NPCs—the app will also discover new ones during generation
